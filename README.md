...
⚠️ As of October 2018, Firefox 63 (beta) does not implement `getSelection()` on the Shadow Root ([issue](https://bugzilla.mozilla.org/show_bug.cgi?id=1430308)). However, the document level API still works within shadow trees, and this polyfill is not needed.
